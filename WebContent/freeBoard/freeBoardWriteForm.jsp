	...
	<section>
		<div class="bBar">
			<div class="position noBMargin">
				...
				<a href="freeBoardList.freeBoard">여행자Talk</a> > 여행자Talk 작성
			</div>
		</div>

		<div class="wBar">
			<div class="position noTMargin">
				<p class="title">여행자Talk ${freeBoard.num} 작성</p>
			</div>	
		</div>
		
		<div class="position formInfo">
			<form name="frm" action="./freeBoardWrite.freeBoard" method="post" enctype="multipart/form-data">
				<table class="notice">
					<tr class="top">
						<td>제목</td>
					...
					<tr class="top">
						<td>작성자</td>
						<td><input class="form-control" type="text" name="writer" value="${sessionScope.member.id}" readonly="readonly"></td>
					</tr>
					...
					<tr><td colspan="2">
						<input type="button" id="write" class="btn" value="작성 완료">
					</td></tr>
				</table>
			</form>
		</div>
