...
<body>
	...
	<section>
		<div class="bBar">
			<div class="position noBMargin">
				...
				<a href="freeBoardList.freeBoard">여행자Talk</a> > 여행자Talk ${freeBoard.num} 수정
			</div>
		</div>

		<div class="wBar">
			<div class="position noTMargin">
				<p class="title">여행자Talk ${freeBoard.num} 수정</p>
			</div>	
		</div>
		
		<div class="position formInfo">
			<form action="./freeBoardMod.freeBoard" name="frm" method="post">
	...
	border-bottom: 1px solid #e6e6e6;">
						<td>제목</td>
						<td><input class="form-control" type="text" name="title" value="${freeBoard.title}"></td>
					</tr>

					<tr style="border-top: 1px solid #e6e6e6;
	border-bottom: 1px solid #e6e6e6;">
						<td>작성자</td>
						<td><input class="form-control" type="text" value="${freeBoard.writer}" readonly="readonly"></td>
					</tr>

					<tr style="border-top: 1px solid #e6e6e6;
	border-bottom: 1px solid #e6e6e6;">
						<td>작성날짜</td>
						<td><input class="form-control" type="date" name="reg_date" value="${freeBoard.reg_date}" readonly="readonly"></td>
					</tr>
					...
					<tr>
						<td colspan="2"><textarea id="se" cols="90px" name="contents">${freeBoard.contents}</textarea></td>
					</tr>
				</table>
			</form>
			...
			<form action="" id="uForm">
				<table class="freeBoard">
					<tr><td>
						<input type="hidden" value="${freeBoard.fnum}" name="pnum" id="pnum">
