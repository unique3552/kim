		...
		<div class="position formInfo">
			...
			<div>
				...
				<table>
					...
					<tr>
						<th>예약번호</th>
						<td class="left">F${requestScope.book.day}-${requestScope.book.num}</td>
						<th>예약상태</th>
						<td class="left">${requestScope.book.status}</td>
					</tr>
					<tr>
						<th>편명</th>
						<td class="left">${requestScope.flight.name}</td>
						<th>항공사</th>
						<td class="left">${requestScope.flight.company}</td>
					</tr>
					<tr>
						<th>출국 날짜</th>
					...
					<tr>
						<th>출발 도시</th>
						<td class="left">${dLocation.region}</td>
						<th>도착 도시</th>
						<td class="left">${aLocation.region}</td>
					</tr>
				</table>
