		...
		<div class="position formInfo">
			...
			<div>
				...
				<table>
					...
					<tr>
						<th>예약번호</th>
						<td class="left">H${requestScope.book.day}-${requestScope.book.num}</td>
						<th>예약상태</th>
						<td class="left">${requestScope.book.status}</td>
					</tr>
					<tr>
						<th>호텔명</th>
						<td class="left">${requestScope.hotel.name}</td>
						<th>호텔 주소</th>
						<td class="left">${requestScope.hotel.address}</td>
					</tr>
					<tr>
						<th>체크인</th>
					...
					<tr>
						<th>룸타입</th>
						<td class="left">${room.roomtype}</td>
						<th>최대 수용 인원수</th>
						<td class="left">${room.pnum}</td>
					</tr>
				</table>
